...
const styles = StyleSheet.create({
  ...
  historyButton: { minHeight: 58, width: '100%', maxWidth: 520, marginTop: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.md, paddingHorizontal: spacing.lg, borderRadius: borderRadius.lg, backgroundColor: 'rgba(124, 181, 24, 0.08)' },
