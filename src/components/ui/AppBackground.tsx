      ...
      <Svg width="100%" height="100%" viewBox="0 0 1440 3200" preserveAspectRatio="xMidYMid slice">
        <Defs>
          ...
          <RadialGradient id="orbBlue" cx="1210" cy="420" rx="620" ry="620" gradientUnits="userSpaceOnUse">
            <Stop offset="0" stopColor="#2A4FE3" stopOpacity="0.15" />
          ...
          <RadialGradient id="orbCyan" cx="220" cy="920" rx="520" ry="520" gradientUnits="userSpaceOnUse">
            <Stop offset="0" stopColor="#2bbfe3" stopOpacity="0.12" />
            <Stop offset="1" stopColor="#2bbfe3" stopOpacity="0" />
          </RadialGradient>
        ...
        <G opacity="0.1">
          <Circle cx="180" cy="210" r="6" fill="#2bbfe3" />
          <Circle cx="380" cy="340" r="4" fill="#2bbfe3" />
          <Circle cx="1280" cy="640" r="5" fill="#2bbfe3" />
          <Circle cx="1160" cy="820" r="3" fill="#2bbfe3" />
          <Circle cx="260" cy="1320" r="4" fill="#2bbfe3" />
          <Circle cx="960" cy="1560" r="5" fill="#2bbfe3" />
          <Circle cx="1180" cy="1860" r="4" fill="#2bbfe3" />
          <Circle cx="420" cy="2300" r="5" fill="#2bbfe3" />
          <Circle cx="1300" cy="2720" r="6" fill="#2bbfe3" />
          <Circle cx="680" cy="3000" r="4" fill="#2bbfe3" />
        </G>
      </Svg>
    </View>
  );
