...
export const OFFER_FEATURE_MATRIX: OfferFeatureRow[] = [
  ...
  { id: 'lumo', label: 'Gagner des Lumo', local: false, habitue: true, eclaireur: true },
  { id: 'shop', label: 'Boutique (boosts & cosmétiques)', local: false, habitue: true, eclaireur: true },
  ...
  { id: 'boost', label: 'Boost créateur (via boutique / Lumo)', local: false, habitue: true, eclaireur: true },
  {
    id: 'right_now',
