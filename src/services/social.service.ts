...
export class SocialService {
  ...
  static async removeFavorite(_userId: string, eventId: string): Promise<void> {
    await dataProvider.removeFavorite(eventId);
  }
  ...
  static async unlike(_userId: string, eventId: string): Promise<void> {
    await dataProvider.unlike(eventId);
  }
