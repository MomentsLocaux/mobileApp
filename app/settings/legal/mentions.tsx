...
const LEGAL_TEXT = [
  ...
  '- Email support et privacy : hello@moments-locaux.com',
  '',
  ...
  'L’utilisateur peut exercer ses droits d’accès, rectification et suppression en contactant : hello@moments-locaux.com',
  '',
  '6. RESPONSABILITÉ',
