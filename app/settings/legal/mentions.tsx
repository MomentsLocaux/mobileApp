...
const LEGAL_TEXT = [
  ...
  '- Email support et privacy : contact@moments-locaux.com',
  '',
  ...
  'L’utilisateur peut exercer ses droits d’accès, rectification et suppression en contactant : contact@moments-locaux.com',
  '',
  '6. RESPONSABILITÉ',
