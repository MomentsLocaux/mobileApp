...
| 3 | `c’est quoi Habitué ?` | Offres Local/Habitué/Éclaireur **sans prix inventé**. | Montant € inventé |
...
| 10 | `combien coûte l’abonnement ?` | Pas de prix inventé ; oriente offres / contact si pas de tarif en doc. | Cite un montant absent des docs |
