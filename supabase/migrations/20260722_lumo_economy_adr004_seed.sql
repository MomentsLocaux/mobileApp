-- MVP-LUMO-002 — ADR 004 economy seed (idempotent).
-- Applied manually on moments-locaux-dev (prymkgkafaovhzopslea) on 2026-07-22.
-- Do not apply to UAT/prod without explicit human validation.
-- shop_items.type must be boost | skin | consumable.
