...
| **Bottom sheet** (`SearchResultsBottomSheet`, `map-sheet-layout`) | Pan au doigt, spring `Motion.spring.sheet`, snaps peek (104 px) → full (92 %) ; pull down en tête de liste replie vers peek |
